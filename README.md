...
![Dashboard Streamlit](images/dashboard_streamlit1.png)
![Dashboard Streamlit - Categorias](images/dashboard_streamlit2.png)
...
│
├── images/
│   ├── dashboard_streamlit1.png
│   ├── dashboard_streamlit2.png
│   ├── orchestrator_run1.png
│   ├── orchestrator_run2.png
│   ├── orchestrator_run3.png
│   └── orchestrator1_results.png
│
├── requirements.txt
└── README.md
```
...
![Orquestrador - Início](images/orchestrator_run1.png)
![Orquestrador - Execução](images/orchestrator_run2.png)
![Orquestrador - Execução](images/orchestrator_run3.png)
![Orquestrador - Resultados](images/orchestrator1_results.png)
